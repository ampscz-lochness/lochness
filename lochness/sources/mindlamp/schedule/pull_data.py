#!/usr/bin/env python
"""
Scheduler task to pull MindLAMP data for all active MindLAMP data sources.
"""
...
MODULE_NAME = "lochness.sources.mindlamp.schedule.pull_data"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Script to schedule MindLAMP metadata refresh jobs."
    )
    parser.add_argument(
        "--project_id",
        "-p",
    ...
    script_path = (
        repo_root / "lochness" / "sources" / "mindlamp" / "tasks" / "pull_data.py"
    )
